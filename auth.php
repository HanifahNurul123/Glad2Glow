...
if (isset($_POST['register'])) {
    ...
    if ($hitung > 0) {
        ...
        $addtotable = mysqli_query($conn, "INSERT INTO login (username, password, email) VALUES ('$username', '$password', '$email')");
        if ($addtotable) {
            echo '<script>alert("Registrasi berhasil! Silakan login."); window.location.href="auth.php";</script>';
        } else {
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>New here?</h3>
                    <p>
                        Join Glad2Glow today! Create an account and start your beauty journey with us.
                    </p>
