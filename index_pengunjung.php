...
.banner-img {
    width: 100%;
    height: 600px; /* Tinggi di laptop/desktop */
    object-fit: cover;
...
@media (max-width: 992px) {
    .banner-img {
        height: 300px; /* Tinggi berkurang sedikit */
    }
}
...
@media (max-width: 576px) {
    .banner-img {
        height: 200px; /* Tinggi mengecil agar pas di layar HP */
    }
}

/* Custom Arrows yang Hampir Memenuhi Samping Layar */
.custom-control {
    width: 10% !important; /* Area hover lebar */
    transition: background-color 0.3s ease;
}

.custom-control:hover {
    background-color: rgba(248, 187, 208, 0.4); /* Efek pink transparan */
}

.carousel-control-prev-icon, .carousel-control-next-icon {
    filter: invert(1) sepia(1) saturate(5) hue-rotate(300deg); /* Membuat icon panah jadi pink/gelap */
}

{
...

    {
        ...
        .card-custom {
            border-radius: 20px;
            box-shadow: 0 6px 18px rgba(199, 85, 170, 1);
            border: none;
            transition: 0.3s;
            cursor: pointer;
            transform: translateY(-8px);
